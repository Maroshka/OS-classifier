...
def main(catslist):
	models = []
	for cat in catslist:
		model = modelaway(cat[0], cat[1], cat[2])
		models.append(model)
	return models
...
if __name__ == '__main__':
	...
	x2, df2 = dfbuilder('realestatefts.txt')
	# models = main([(df, x,'CARS.json'), (df2, x2, 'REALESTATE.json')])
	models = main([(df2, x2, 'REALESTATE.json')])
	# gui(model, df, x)
